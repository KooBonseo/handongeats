...
background: #FCFDFF;}
    ...
    .sold-out {
      ...
      footer{color: #1368BD;
            ...
            nav{width: 80%; height: 54px; 
            display:flex;flex-shrink: 0; flex-wrap:nowrap;
            color: #000; padding:7px; font-family: Pretendard; 
            font-size: 22px; font-style: normal; font-weight: 500;
            line-height: normal; padding:5px; border-radius: 10px; margin-bottom: 0px;}
          
            h5{color: #1368BD;}
            
            header img {height: 60px; object-fit: contain;}
            header img {height: 60px; object-fit: contain;}
            .category {padding: 8px 16px;border: 2px solid #1368BD;border-radius: 12px;background-color: #FCFDFF;font-family: Pretendard;
            font-size: 16px;font-weight: 600;color: #1368BD;white-space: nowrap;text-align: center; margin-bottom: 30px;}
...
* {
    ...
    header {
      ...
      border-bottom: 2px solid #1368BD;
      padding: 20px 40px;
      display: flex;
  ...
  <header>
    <div class="header">
      <div class="category-boxes">
        ...
        <div class="category">#매점*편의점</div>
      </div>
      <nav>
        <a href="편의점 페이지.html">편의점</a>
        <a href="store.html">매점</a>
      </nav>
    </div>
  </header>
</header>
<br>
  <main style="padding: 20px;">
    <h5>운영 시간</h5>
    <h5>학기 중: 09:00~21:00<br>방학 중: 09:00~18:00</h5>
    <h5 id="안내">*봉지라면 조리 가능</h5>
  ...
  <div class="item-list">
    ...
    <div class="item">
      ...
      <p>라면 용기 (800원)</p>
      <!-- 버튼 관련된 부분은 챗gpt의 도움을 받음. -->
      <button onclick="toggleSoldOut('remyeon-status')">완판 처리</button>
...
<div class="item">
    ...
    <br><br>
    <div class="item">
      <img src="watermelon.jpeg" alt="수박컵">
      <p>수박컵 (2,500원)</p>
      <!-- 버튼 관련된 부분은 챗gpt의 도움을 받음. -->
  ...
  <div class="item">
      <img src="jja.jpeg" alt="짜파게티">
      <p>짜파게티 (1,300원)</p>
      <!-- 버튼 관련된 부분은 챗gpt의 도움을 받음. -->
      <button onclick="toggleSoldOut('jja-status')">완판 처리</button>
      <div id="jja-status" class="sold-out" style="display: none;">✅ 완판되었습니다</div>
    </div>
    <div class="item">
      <img src="jinsoon.jpeg" alt="진순">
      <p>진라면 순한맛 (900원)</p>
      <!-- 버튼 관련된 부분은 챗gpt의 도움을 받음. -->
    ...
    <div class="item">
      <img src="gor.jpeg" alt="고르곤졸라">
      <p>고메고르곤졸라피자 (6,980원)</p>
      <!-- 버튼 관련된 부분은 챗gpt의 도움을 받음. -->
    ...
    <div class="item">
      <img src="meat.jpeg" alt="고메미트볼파스타">
      <p>고메미트볼파스타 (4,750원)</p>
      <!-- 버튼 관련된 부분은 챗gpt의 도움을 받음. -->
      <button onclick="toggleSoldOut('meat-status')">완판 처리</button>
      <div id="meat-status" class="sold-out" style="display: none;">✅ 완판되었습니다</div>
    </div>


    <div class="item">
      <img src="nak.jpeg" alt="비비고/낙지비빔밥">
      <p>비비고 낙지비빔밥 (3,180원)</p>
      <!-- 버튼 관련된 부분은 챗gpt의 도움을 받음. -->
    ...
    <div class="item">
      <img src="gimchi.jpeg" alt="김치볶음밥">
      <p>cj 스팸김치볶음밥 (3,400원)</p>
      <!-- 버튼 관련된 부분은 챗gpt의 도움을 받음. -->
...
<div class="item">
    ...
    <div class="item">
      <img src="dakbok.jpeg" alt="비비고/닭가슴살볶음밥">
      <p>비비고 닭가슴살볶음밥 (6,350원)</p>
      <!-- 버튼 관련된 부분은 챗gpt의 도움을 받음. -->
...
<div class="item">
      <img src="gon.jpeg" alt="비비고/곤드레나물밥">
      <p>비비고 곤드레나물밥 (6,350원)</p>
      <!-- 버튼 관련된 부분은 챗gpt의 도움을 받음. -->
      <button onclick="toggleSoldOut('gon-status')">완판 처리</button>
      <div id="gon-status" class="sold-out" style="display: none;">✅ 완판되었습니다</div>
    </div>

  <footer style="background-color: #F2F4F7; color: #1368BD; height: 317px;">
            <img src="logo_BLUE.svg" alt="HANDONG EATS" height="54" style="position: relative; top: 78px; left: 80px;">
            <p style="position: absolute; left: 80px; font-size: 18px; position: relative; top: 159px;">2025-Summer 프론트엔드 입문<br>
...
<script>
  ...
  const firebaseConfig = {
    ...
    storageBucket: "handongeats.firebasestorage.app",
...
<script>
  ...
  window.onload = function () {
    const itemIds = [
      ...
      "jja-status", "jinsoon-status", "yeol-status", "stake-status",
      "gor-status", "meat-status", "nak-status", "bul-status",
      "gimchi-status", "ggmandoo-status", "gimchiman-status",
      "dak-status", "dakbok-status", "gon-status"
    ];
